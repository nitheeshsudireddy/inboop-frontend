          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            <div>
              <button
                ...
                className="w-full py-2.5 border border-gray-200 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:border-gray-200"
              >
                {isGoogleLoading ? (
                  <>
